...
source("/SAN/mottlab/heterosis/bin/Heterosis_Models/1_GWAS_AddDom_QC.r")
source("/SAN/mottlab/heterosis/bin/Heterosis_Models/2_GWAS_AddDom_Pvalue.r")
source("/SAN/mottlab/heterosis/3_HSrats/3NonAdd_QTL/RawPhe_Plot_Script/3_GWAS_AddDom_Plot.r")
#source("/SAN/mottlab/heterosis/3_HSrats/3NonAdd_QTL/RawPhe_Plot_Script/3_GWAS_AddDom_Plot_All.r")
...
outdir = "/SAN/mottlab/heterosis/3_HSrats/3NonAdd_QTL/1_A+D"
...
#GWAS_AddDom_QC(indir=indir, outdir=outdir, Input_name="HSrats", Input_type="PLINK", Kinship_type="GCTA_ad", PheList_Choose=F, PheList=PheList, Phe_ResDone = F, Phe_NormDone = T, Normal_method = "QUANTILE", covariates_sum=10, Phe_IndMinimum = 200, Phe_Extreme = 5, GT_maf = 0.05, GT_missing = 0.1, num_nodes=15)

#GWAS_AddDom_Pvalue(indir=indir, outdir=outdir, Input_name="HSrats", Kinship_type="GCTA_ad", VarComponent_Method="GCTA_ad", PheList_Choose=F, PheList=PheList, Run_separated = F,covariates_sum=10, covariates_types=covariates_types, Phe_IndMinimum=200, GT_IndMinimum=10, num_nodes=20)

GWAS_AddDom_Plot(outdir=outdir, PheList_Choose=F, PheList=PheList, covariates_sum=10, RegionMan_chr_whole=F, RegionMan_chr_region = 15000000, num_nodes=15)
