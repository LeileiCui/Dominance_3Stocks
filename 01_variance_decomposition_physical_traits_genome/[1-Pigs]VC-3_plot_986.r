...
outdir = "/SAN/mottlab/heterosis/1_F2pigs/5VC/2_921Inds/"; setwd(outdir)

grmAdd = read.table(file="F2_Final_add.grm.gz"); grmDom = read.table(file="F2_Final_dom.d.grm.gz")
...
rm(list=ls());options(stringsAsFactors=FALSE)
outdir = "/SAN/mottlab/heterosis/1_F2pigs/5VC/2_921Inds/"; setwd(outdir)
outdir_VC = "/SAN/mottlab/heterosis/1_F2pigs/5VC/2_921Inds/add_dom_VC"
hsq_list = list.files(path="/SAN/mottlab/heterosis/1_F2pigs/5VC/2_921Inds/add_dom_VC", pattern=".hsq")
...
color = read.table("/SAN/mottlab/heterosis/1_F2pigs/5VC/data/Data_clean_colors.txt",header=T,stringsAsFactors=F,sep="\t"); rownames(color) = color[,1]
...
######################################################################################################################
rm(list=ls());options(stringsAsFactors=FALSE)
outdir = "/SAN/mottlab/heterosis/1_F2pigs/5VC/2_921Inds/"
