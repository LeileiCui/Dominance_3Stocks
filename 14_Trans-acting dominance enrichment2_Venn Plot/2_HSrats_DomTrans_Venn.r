...
setwd("/Users/leileicui/Desktop/1_项目资料/2_NonAdditive/结果汇总/Heterosis_Results_2【初步整理结果】/6-2-Dom Enrichment-Venn Plot/2-HSrats")
...
ploteQTL_2Venn(eQTL_data1_plot,plotname="HSrats_amygdala_g_AvsD")
ploteQTL_4Venn(eQTL_data1_plot,plotname="HSrats_amygdala_g")
...
ploteQTL_2Venn(eQTL_data2_plot,plotname="HSrats_heart_g_AvsD")
ploteQTL_4Venn(eQTL_data2_plot,plotname="HSrats_heart_g")
...
ploteQTL_2Venn(eQTL_data1_plot,plotname="HSrats_amygdala_t_AvsD")
ploteQTL_4Venn(eQTL_data1_plot,plotname="HSrats_amygdala_t")
...
ploteQTL_2Venn(eQTL_data2_plot,plotname="HSrats_heart_t_AvsD")
ploteQTL_4Venn(eQTL_data2_plot,plotname="HSrats_heart_t")
