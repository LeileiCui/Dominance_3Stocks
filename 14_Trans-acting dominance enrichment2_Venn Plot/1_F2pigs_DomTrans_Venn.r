...
setwd("/Users/leileicui/Desktop/1_项目资料/2_NonAdditive/结果汇总/Heterosis_Results_2【初步整理结果】/6-2-Dom Enrichment-Venn Plot/1-F2pigs")
...
ploteQTL_2Venn(eQTL_data1_plot,plotname="F2pigs_liver_AvsD")
ploteQTL_4Venn(eQTL_data1_plot,plotname="F2pigs_liver")
...
ploteQTL_2Venn(eQTL_data2_plot,plotname="F2pigs_muscle_AvsD")
ploteQTL_4Venn(eQTL_data2_plot,plotname="F2pigs_muscle")
