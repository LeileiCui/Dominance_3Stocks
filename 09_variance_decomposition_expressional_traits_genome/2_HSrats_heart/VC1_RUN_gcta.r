...
datdir = c("/SAN/mottlab/heterosis/3_HSrats/1data/RAW_DGE_Genes")
group_name = "HSrats_heart"
cov_num = 3; threadnum = 10

outdir = paste0("/SAN/mottlab/heterosis/3_HSrats/5VC_gene/", group_name, "/1data")
setwd(outdir)
