...
setwd("/SAN/mottlab/heterosis/1_F2pigs/3NonAdd_QTL/1_A+D/1_PheGen/0_Data")

phe_all = read.table("/SAN/mottlab/heterosis/1_F2pigs/3NonAdd_QTL/1_A+D/1_PheGen/5_PheTrans/Phe_Trans.txt",header=T)
...
for(i in 4:length(colnames(phe_all))){
try({
...
rm(list=ls());options(stringsAsFactors=FALSE)
setwd("/SAN/mottlab/heterosis/1_F2pigs/3NonAdd_QTL/Venn-Plot")

load("/SAN/mottlab/heterosis/1_F2pigs/3NonAdd_QTL/1_A+D/1_PheGen/0_Data/GT_Minimum_all.RData")
