...
outdir = "/SAN/mottlab/heterosis/3_HSrats/3NonAdd_eQTL_Gene/1_A+D_amygdala"

covariates_types = c("n", "n", "n"); names(covariates_types) = c("age", "sex", "BW_at_day28_pi")
PheList = c("id", "age", "sex", "BW_at_day28_pi", "ENSRNOT00000000007", "ENSRNOT00000000133", "ENSRNOT00000000178")

# [3] Use three functions one by one #
#ADDO_AddDom1_QC(indir=indir, outdir=outdir, Input_name="HSrats_amygdala", Input_type="PLINK", Kinship_type="GCTA_ad", PheList_Choose=F, PheList=PheList, Phe_ResDone = F, Phe_NormDone = T, Normal_method = "QUANTILE", covariates_sum=3, covariates_types=covariates_types, Phe_IndMinimum = 100, Phe_Extreme = 5, GT_maf = 0.05, GT_missing = 0.1, num_nodes=15)

ADDO_AddDom2_Pvalue(indir=indir, outdir=outdir, Input_name="HSrats_amygdala", Kinship_type="GCTA_ad", VarComponent_Method="GCTA_ad", PheList_Choose=F, PheList=PheList, covariates_sum=3, Phe_IndMinimum=100, GT_IndMinimum=10, matrix_acceleration=F, num_nodes=4)
