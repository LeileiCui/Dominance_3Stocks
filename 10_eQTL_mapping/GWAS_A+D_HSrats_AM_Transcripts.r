...
outdir = "/SAN/mottlab/heterosis/3_HSrats/3NonAdd_eQTL/1_A+D_0.999999r2_Amygdala"
...
#GWAS_AddDom_QC(indir=indir, outdir=outdir, Input_name="HSrats_0.999999r2_amygdala", Input_type="PLINK", Kinship_type="GCTA_ad", PheList_Choose=F, PheList=PheList, Phe_ResDone = F, Phe_NormDone = T, Normal_method = "QUANTILE", covariates_sum=3, Phe_IndMinimum = 100, Phe_Extreme = 5, GT_maf = 0.05, GT_missing = 0.1, num_nodes=15)

#GWAS_AddDom_Pvalue(indir=indir, outdir=outdir, Input_name="HSrats_0.999999r2_amygdala", Kinship_type="GCTA_ad", VarComponent_Method="GCTA_ad", PheList_Choose=F, PheList=PheList, Run_separated = F, Run_separated_length = 300000,covariates_sum=3, covariates_types=covariates_types, Phe_IndMinimum=100, GT_IndMinimum=10, num_nodes=15)
