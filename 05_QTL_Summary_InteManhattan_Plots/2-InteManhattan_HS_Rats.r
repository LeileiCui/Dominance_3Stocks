...
setwd("/home/ucbtlcu/heterosis_mnt/3_HSrats/3NonAdd_QTL/1_A+D_0.999999r2/2_Pvalue"); chr_rm = c(23)
color_sum = read.table("/home/ucbtlcu/heterosis_mnt/3_HSrats/1data/HSrats.cols",header=T,sep="\t")
png_title = "HS_Rats"; logP_filter = 2; Nsnp = 61185; chrs_sum = 20; y_limit = 17
