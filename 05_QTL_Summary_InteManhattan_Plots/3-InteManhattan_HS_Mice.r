...
setwd("/home/ucbtlcu/heterosis_mnt/4_HSmice/3NonAdd_QTL/1_A+D/2_Pvalue"); chr_rm = c(23)
color_sum = read.table("/home/ucbtlcu/heterosis_mnt/4_HSmice/1data/HSmice.cols",header=T,sep="\t")
png_title = "HS_Mice"; logP_filter = 2; Nsnp = 8637; chrs_sum = 19; y_limit = 17
